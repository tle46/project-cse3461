...
### Dependencies
Firstly, ensure that Python and tinker are installed.
...
Ensure that SERVER_IP and SERVER_PORT variables are properly set in the feature2_client.py file.

```
python3 feature2_client.py
```
...
```
python3 feature2_ClientGUI.py
```
Manually set the server IP and port address in the feature2_GUIClasses.py file.
